...
- Различные функции клеток (обновление фенотипа, подвижность, клеточный контакт и др.).
...
- События модели. 
- События, происходящие при появлении в модели новой клетки.
...
:raw-html:`<br>`
Список всех java-классов пакета ru.biosoft.Physicell и их краткое описание представлены ниже.
