...
1. **Примитивные (primitive)** - это базовые типы, встроенные в язык java. Они не являются объектами и хранят непосредственное значение.
  ...
  - :ref:`int <PhysiCell_java_Data_types_Int>` - целые числа.
  - :ref:`double <PhysiCell_java_Data_types_Double>` - действительные числа.
  - :ref:`boolean <PhysiCell_java_Data_types_Boolean>` - логические операторы.

2. **Ссылочные (reference)** - эти типы ссылаются на объекты в памяти.

  - :ref:`String <PhysiCell_java_Data_types_String>` - последовательность символов.
  - :ref:`Array <PhysiCell_java_Data_types_Array>` - массив.
  - :ref:`List <PhysiCell_java_Data_types_List>` - список.
