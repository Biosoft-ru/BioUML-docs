...
Чтобы настроить и запустить симуляцию модели нужно нажать ЛКМ на вкладку **Simulation**.
...
:raw-html:`<br>`
После этого в правом нижнем углу экрана у вас появится панель для настройки симуляции модели.
...
:raw-html:`<br>`
На этой вкладке можно выделить несколько областей:
...
- Кнопки для управления процессом симуляции (A).
- Вкладки для переключения между настройками параметров симуляции (Engine) и меню добавления переменных для вывода на график (Plots) (B).
- Область редактирования параметров симуляции (Engine) и меню добавления переменных для вывода на график (Plots) (C).
- Область вывода логов (D).
...
.. toctree::
   ...
   PhysiCell_simulation_Buttons
   PhysiCell_simulation_Settings
   PhysiCell_simulation_Engine
   PhysiCell_simulation_Plots
   PhysiCell_simulation_General_files
